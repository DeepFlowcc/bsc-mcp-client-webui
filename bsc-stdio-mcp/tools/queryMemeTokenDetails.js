...
export function registerQueryMemeTokenDetails(server) {
    server.tool("QueryMemeTokenDetails", "Fetches token details for a given meme token using the four.meme API. Default price in USDT.", {
